; ModuleID = '../src/RealMM.c'
source_filename = "../src/RealMM.c"
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [41 x double], ptr %4, i64 %idxprom
  %6 = load i32, ptr %j, align 4
  %idxprom6 = sext i32 %6 to i64
  %arrayidx7 = getelementptr inbounds [41 x double], ptr %arrayidx, i64 0, i64 %idxprom6
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx2 = getelementptr inbounds [41 x double], ptr %arrayidx, i64 0, i64 %idxprom1
  %7 = load double, ptr %arrayidx2, align 8
  %8 = load ptr, ptr %b.addr, align 8
  %9 = load i32, ptr %i, align 4
  %idxprom3 = sext i32 %9 to i64
  %arrayidx4 = getelementptr inbounds [41 x double], ptr %8, i64 %idxprom3
  %10 = load i32, ptr %column.addr, align 4
  %idxprom5 = sext i32 %10 to i64
  %arrayidx6 = getelementptr inbounds [41 x double], ptr %arrayidx4, i64 0, i64 %idxprom5
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [41 x [41 x double]], ptr @rmr, i64 0, i64 %idxprom
  %3 = load i32, ptr %j, align 4
  %idxprom4 = sext i32 %3 to i64
  %arrayidx5 = getelementptr inbounds [41 x double], ptr %arrayidx, i64 0, i64 %idxprom4
...
for.end8:                                         ; preds = %for.cond
  ...
  %arrayidx10 = getelementptr inbounds [41 x [41 x double]], ptr @rmr, i64 0, i64 %idxprom9
  %9 = load i32, ptr %run.addr, align 4
  %add11 = add nsw i32 %9, 1
  %idxprom12 = sext i32 %add11 to i64
  %arrayidx13 = getelementptr inbounds [41 x double], ptr %arrayidx10, i64 0, i64 %idxprom12
  %10 = load double, ptr %arrayidx13, align 8
  %call = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %10)
  ret void
}
