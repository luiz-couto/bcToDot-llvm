...
while.body3:                                      ; preds = %while.cond1
  ...
  %arrayidx5 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %idxprom4
...
if.then:                                          ; preds = %while.body3
  ...
  %arrayidx11 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %idxprom10
  %10 = load i32, ptr %arrayidx11, align 4
  %11 = load i32, ptr %i, align 4
  %idxprom12 = sext i32 %11 to i64
  %arrayidx13 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %idxprom12
  store i32 %10, ptr %arrayidx13, align 4
  %12 = load i32, ptr %j, align 4
  %13 = load i32, ptr %i, align 4
  %add14 = add nsw i32 %13, 1
  %idxprom15 = sext i32 %add14 to i64
  %arrayidx16 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %idxprom15
...
lor.lhs.false:                                    ; preds = %while.end18
  %18 = load i32, ptr getelementptr inbounds ([5001 x i32], ptr @sortlist, i64 0, i64 500), align 16
...
if.end22:                                         ; preds = %if.then21, %lor.lhs.false
  %20 = load i32, ptr %run.addr, align 4
  ...
  %call26 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %21)
  ret void
}
