; ModuleID = '../src/IntMM.c'
source_filename = "../src/IntMM.c"
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Initmatrix(ptr noundef %m) #0 {
entry:
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [41 x i32], ptr %4, i64 %idxprom
  %6 = load i32, ptr %j, align 4
  %idxprom5 = sext i32 %6 to i64
  %arrayidx6 = getelementptr inbounds [41 x i32], ptr %arrayidx, i64 0, i64 %idxprom5
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Innerproduct(ptr noundef %result, ptr noundef %a, ptr noundef %b, i32 noundef %row, i32 noundef %column) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx2 = getelementptr inbounds [41 x i32], ptr %arrayidx, i64 0, i64 %idxprom1
  %7 = load i32, ptr %arrayidx2, align 4
  %8 = load ptr, ptr %b.addr, align 8
  %9 = load i32, ptr %i, align 4
  %idxprom3 = sext i32 %9 to i64
  %arrayidx4 = getelementptr inbounds [41 x i32], ptr %8, i64 %idxprom3
  %10 = load i32, ptr %column.addr, align 4
  %idxprom5 = sext i32 %10 to i64
  %arrayidx6 = getelementptr inbounds [41 x i32], ptr %arrayidx4, i64 0, i64 %idxprom5
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [41 x [41 x i32]], ptr @imr, i64 0, i64 %idxprom
  %3 = load i32, ptr %j, align 4
  %idxprom4 = sext i32 %3 to i64
  %arrayidx5 = getelementptr inbounds [41 x i32], ptr %arrayidx, i64 0, i64 %idxprom4
  %4 = load i32, ptr %i, align 4
  %5 = load i32, ptr %j, align 4
  call void @Innerproduct(ptr noundef %arrayidx5, ptr noundef @ima, ptr noundef @imb, i32 noundef %4, i32 noundef %5)
  br label %for.inc
...
for.end8:                                         ; preds = %for.cond
  ...
  %arrayidx10 = getelementptr inbounds [41 x [41 x i32]], ptr @imr, i64 0, i64 %idxprom9
  %9 = load i32, ptr %run.addr, align 4
  %add11 = add nsw i32 %9, 1
  %idxprom12 = sext i32 %add11 to i64
  %arrayidx13 = getelementptr inbounds [41 x i32], ptr %arrayidx10, i64 0, i64 %idxprom12
