; ModuleID = '../src/Puzzle.c'
source_filename = "../src/Puzzle.c"
...
for.inc150:                                       ; preds = %for.body143
  ...
  store i32 %inc151, ptr %k, align 4
...
for.inc198:                                       ; preds = %for.body191
  ...
  store i32 %inc199, ptr %k, align 4
...
for.inc246:                                       ; preds = %for.body239
  ...
  store i32 %inc247, ptr %k, align 4
...
for.inc273:                                       ; preds = %for.end272
  ...
  store i32 %inc274, ptr %j, align 4
...
for.inc294:                                       ; preds = %for.body287
  ...
  store i32 %inc295, ptr %k, align 4
...
for.inc297:                                       ; preds = %for.end296
  ...
  store i32 %inc298, ptr %j, align 4
...
for.inc318:                                       ; preds = %for.body311
  ...
  store i32 %inc319, ptr %k, align 4
...
for.inc342:                                       ; preds = %for.body335
  ...
  store i32 %inc343, ptr %k, align 4
...
for.inc345:                                       ; preds = %for.end344
  ...
  store i32 %inc346, ptr %j, align 4
...
for.inc348:                                       ; preds = %for.end347
  ...
  store i32 %inc349, ptr %i, align 4
...
if.end362:                                        ; preds = %if.end361, %if.then355
  ...
  %call363 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %139)
  %140 = load i32, ptr @kount, align 4
  %call364 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %140)
  ret void
}
