...
do.end:                                           ; preds = %do.cond
  %33 = load i32, ptr %l.addr, align 4
...
if.then23:                                        ; preds = %do.end
  ...
  call void @Quicksort(ptr noundef %35, i32 noundef %36, i32 noundef %37)
  br label %if.end24
...
if.then26:                                        ; preds = %if.end24
  ...
  call void @Quicksort(ptr noundef %40, i32 noundef %41, i32 noundef %42)
  br label %if.end27
...
if.end:                                           ; preds = %if.then, %lor.lhs.false
  %4 = load i32, ptr %run.addr, align 4
  %add = add nsw i32 %4, 1
